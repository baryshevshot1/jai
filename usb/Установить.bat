...
rem Маска БЕЗ кавычек: в кавычках cmd.exe трактует её как обычную строку и не
rem подставляет имя файла, а %%~f снимает кавычки, если они всё же появятся, —
rem иначе start получил бы имя с лишними кавычками и установка сорвалась бы.
set "APP="
set /a APPCOUNT=0
